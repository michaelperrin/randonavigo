...
gpx_alternatives:
  - file: les-bords-de-seine-pleine-nature - alt.gpx
    label: "Eviter le passage submergé si la Seine est haute"
hidden: false
...
On poursuit sur le chemin qui longe la Seine parmi les arbres sur plusieurs kilomètres. J'ai beaucoup aimé les petites péniches égrenées ici et là.
...
Vous verrez que le chemin passe vraiment au milieu de l'eau. C'est très joli, mais il y a un petit passage pour lequel il ne faudra pas hésiter à déchausser pour passer !

<InfoBox type="warning">
Attention ! Cette partie du chemin pourrait facilement être **submergée** si le niveau Seine monte après des épisodes de pluie. Il faudra alors être **vigilant** ou même emprunter des chemins alternatifs comme cela m'a été remonté par un groupe de randonneurs (merci 😉).

Je vous propose dans ce cas une <a href="/hikes/2023/06/les-bords-de-seine-pleine-nature/gpx/les-bords-de-seine-pleine-nature%20-%20alt.gpx">**trace alternative**</a> que vous pouvez télécharger sur cette page pour éviter la zone submergée.
</InfoBox>
