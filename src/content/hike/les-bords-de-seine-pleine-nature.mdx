...
Vous verrez que le chemin passe vraiment au milieu de l'eau. Sur une petite zone, il faudra peut-être même déchausser pour passer entre les cailloux !

<InfoBox type="info">
Attention ! Cette partie du chemin pourrait facilement être **submergée** si le niveau Seine est monté après des épisodes de pluie. Il faudra alors être **vigilant** ou même emprunter des chemins alternatifs comme cela m'a été remonté par un groupe de randonneurs.
