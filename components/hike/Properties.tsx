...
const HikeProperties = ({ hike }: HikePropertiesProps) => (
  <div className="md:mb-12">
    <div className="md:shadow-lg md:rounded-xl" style={{ fontFamily: 'Barlow' }}>
      ...
      {/* <a className="block w-full font-sans bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 after:bg-gradient-to-r after:from-yellow-400 after:via-red-500 after:to-pink-500 after:blur-2xl after:absolute relative after:inset-0 after:z-10 z-20 hover:bg-yellow-700 text-white text-center py-3 px-4 uppercase font-semibold rounded-b-xl" download href={getHikeGpxPath(hike)} style={{ fontFamily: 'Barlow' }}> */}
      {/* <a className="block w-full font-sans bg-gradient-to-r from-softblue via-softblue to-indigo-700 after:bg-gradient-to-r after:from-softblue after:indigo-700 after:blur-2xl after:absolute relative after:inset-0 after:z-10 z-20 hover:bg-yellow-700 text-white text-center py-4 px-4 uppercase font-semibold rounded-b-xl" download href={getHikeGpxPath(hike)} style={{ fontFamily: 'Barlow' }}> */}
